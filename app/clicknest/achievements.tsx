...
export default function Achievements() {
  return (
    <LinearGradient colors={["#F7F0FF", "#EFE4FF", "#E5D8FF"]} style={styles.container}>
      <View style={styles.card}>
        <Text style={styles.title}>Achievements</Text>
        <Text style={styles.sub}>Theme updated across this page too.</Text>
        <Text style={styles.note}>Awards and success highlights can be listed here.</Text>
      </View>
    </LinearGradient>
  );
}
