  ...
  return (
    ...
    >
      ...
      >
        ...
        <TouchableOpacity
          style={styles.actionRow}
          onPress={() => router.push("/clicknest/campus-videos")}
          activeOpacity={0.85}
        >
          <View style={[styles.accentBar, { backgroundColor: "#8D6BFF" }]} />
          <Text style={styles.actionText}>Campus Videos</Text>
        </TouchableOpacity>
...
>>>>>>> d0772b9fc058d629103f2901a3bdb66537f2dec0:app/clicknest.tsx
